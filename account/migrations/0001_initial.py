# Generated by Django 3.2.4 on 2021-08-01 15:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency_bank_approve', models.CharField(default='PENDING', max_length=100)),
                ('agency_bank_name', models.TextField(blank=True, null=True)),
                ('ab_date_action', models.DateField(blank=True, null=True)),
                ('repaid', models.CharField(default='PENDING', max_length=100)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family_on_hcdti_group', models.TextField(blank=True, null=True)),
                ('savings_in_passbook', models.TextField(blank=True, null=True)),
                ('bank', models.TextField(blank=True, null=True)),
                ('account_no', models.TextField(blank=True, null=True)),
                ('member_owning_mfi', models.BooleanField(null=True)),
                ...
                ('group_member', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='account.groupmember')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.groups'),
        ),
        migrations.CreateModel(
            name='ApprovedLoan',
            fields=[
                ...
                ('loan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approve', to='account.loanapplication')),
            ],
            options={
